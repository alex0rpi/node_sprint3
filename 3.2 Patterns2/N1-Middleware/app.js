...
// console.log(app.suma()); //expects an object {}
// validació pel cas que no hi ha arguments??
console.log(app.resta({ a: 3, b: 2, c: 2 })); //expects an object {}
console.log(app.multiplica({ a: 3, b: 2, c: 2 })); //expects an object {}
